...
function FreeboxFinder (config, env) {
    ...
    this.io.on('connection', function (socket) {
        ...
        socket.on('new-box-now', function (newBox) {
            ...
            debug('new-box: ', newBox);

            debug('newBox', newBox);

            var location = new Location.model(newBox.location)
            ...
            location.save(function (err, savedLocation) {
                ...
                debug('savedLocation', savedLocation);

                newBox.location = savedLocation._id
                ...
                box.save(function (err, savedBox) {
                    ...
                    // if the box was saved successfully
                        ...
                        self.io.in(savedBox.location.zip).emit('new-box', savedBox);
                    }
                });
