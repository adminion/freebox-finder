...
boxSchema.methods.cityState = function () {
    return this.location.address_components.locality.short_name + ', ' + this.location.address_components.administrative_area_level_1.short_name;
};

boxSchema.methods.lat = function () {
    return this.location.coords.lat;
};

boxSchema.methods.lng = function () {
    return this.location.coords.lng;
};
